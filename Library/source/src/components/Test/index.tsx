    ...
    return (
        ...
        >
            <li
                onClick={e => {
                    // alertModal("test");
                    setState({ showModal: true, modalType: "no_storage" });
                }}
            >
                弹出modal
            </li>
            <li>
                <span
                    onClick={e => {
                        setState({ msgType: "cancel_collect", showMsg: true });
                        e.stopPropagation();
                    }}
                >
                    弹出msg
            ...
            <li>
                <span
                    onClick={e => {
                        ...
                        setState({ showOperate: true, operateType: "collection" || "gallery" || "collection" });
                    }}
                >
                    多选操作面板
                </span>
