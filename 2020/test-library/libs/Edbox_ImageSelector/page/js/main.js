var Manager = {
    ...
    /**
     * 初始化平台数据（大部分可以从EdboxSdk里获取）
     */
    InitPlatform: function() {
        var ua = navigator.userAgent;
        var platform = Manager.Platform;
        platform.IsAndroid = Edbox.Platform.IsAndroid;
        platform.IsIOS = Edbox.Platform.IsIOS;
        platform.IsPC = Edbox.Platform.IsPC;
        platform.IsEdbox = Edbox.Platform.IsEdbox;
    ...
    Init: function() {
        ...
        Edbox.Start(); //必须重新Start一次，否则获取不到基础数据，上传NDR会报错
