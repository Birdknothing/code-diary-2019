 ...
 * Edbox模块
 */
var EdboxModule = angular.module("Edbox", ["ngRoute", "ngTouch", "Edbox.datas"]);
...
var DataFunction = {
    ...
    GetText: function(key) {
        ...
        if (Edbox.Language === "English") {
            return Datas.Texts[key].EnglishValue;
        } else if (Edbox.Language === "SimplifiedChinese") {
...
// 初始化Datas模块
angular.module("Edbox.datas", []).controller("DatasCtrl", ["$scope", function($scope) {
    $scope.Datas = Datas;
...
// 初始化移动事件
EdboxModule.directive("ngTouchstart", function() {
    return {
