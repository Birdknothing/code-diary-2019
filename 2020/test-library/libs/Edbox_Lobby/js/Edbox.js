...
(function (module) {
    ...
    InitRequire("Edbox_Lobby/js/Edbox_Lobby.js");
    InitRequire("Edbox_Lobby/js/Edbox_LobbyService.js");
    InitRequire("Edbox_WebSocket/js/Edbox_WebSocket.js");
    InitRequire("Edbox_Lobby/js/Beginner_Guide.js");
    InitRequire("Edbox_Lobby/js/Edbox_Task.js");
    // InitRequire("Edbox_FeedBack/js/Edbox_FeedBack.js");
    InitRequire("Edbox_Lobby/js/ScreenShot.js");
