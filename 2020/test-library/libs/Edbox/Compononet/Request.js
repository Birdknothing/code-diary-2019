...
(function (namespace, className) {
     ...
     * @author 温荣泉(201901)
     * @see http://ndsdn.nd.com.cn/index.php?title=Edbox%E9%80%9A%E7%94%A8%E8%AF%B7%E6%B1%82%E6%8E%88%E6%9D%83%E7%BB%84%E4%BB%B6JS%E7%89%88
     */
    var module = {
        /**
         * 获取授权信息
         ...
         * @returns {Object} Ajax对象
         */
        Post: function (host, url, data, success, error, protocol) {
            return module.PostWithHeader(host, url, data, null, success, error, protocol);
        },
         ...
         * @returns {Object} Ajax对象
         */
        PostWithLanguage: function (host, url, data, success, error, protocol) {
            var language = namespace.GetLanguageCode();
            if (language === "zh-TW") {
                language = "zh-HK";
            }
         ...
         * @returns {Object} Ajax对象
         */
        PostWithEnv: function (host, url, data, success, error, protocol) {
            return module.PostWithHeader(host, url, data, {
                env: namespace.Mode
            }, success, error, protocol);
        },
         ...
         * @returns {Object} Ajax对象
         */
        Put: function (host, url, data, success, error, protocol) {
            return module.PutWithHeader(host, url, data, null, success, error, protocol);
        },

        /**
         * Put请求获取数据，带请求头，如服务器不支持，将出现跨域问题
         * @param {String} host Host: "192.168.211.67:19001"
         * @param {String} suburl URL地址 "/index.html"
         * @param {String} data 请求数据
         * @param {Object} header 请求头
         ...
         * @returns {Object} Ajax对象
         */
        PutWithHeader: function (host, suburl, data, header, success, error, protocol) {
            var httpmethod = "Put";
            if (data) {
                data = JSON.parse(data);
            }
