...
(function (namespace, className) {
    ...
    function FeedBackGet(url, data, success, error) {
        ...
        header["vorg"] = "edbox";
        header["accept-language"] = TransferLanguage(Edbox.Language);
        Edbox.Request.GetWithHeader(Edbox.GetHost("FeedBack"), url, data, header, success, error, "https");
    }
    ...
    function FeedBackPost(url, data, success, error) {
        ...
        header["vorg"] = "edbox";
        header["accept-language"] = TransferLanguage(Edbox.Language);
        Edbox.Request.PostWithHeader(Edbox.GetHost("FeedBack"), url, data, header, success, error, "https");
    }
    ...
    function FeedBackPatch(url, data, success, error) {
        ...
        header["vorg"] = "edbox";
        header["accept-language"] = TransferLanguage(Edbox.Language);
        Edbox.Request.PatchWithHeader(Edbox.GetHost("FeedBack"), url, data, header, success, error, "https");
    }
    ...
    var module = {
        ...
        */
        PostFeedBack: function (model_id, contact, feedback_type, content, scene, subscript, screenshot, success, error) {
            ...
            feedback.nick_name = Edbox.UserName;
