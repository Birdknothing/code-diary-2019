...
(function (namespace, className) {
   ...
   */
    function MakeShareUrl(appid) {
        var url = 'http://' + Edbox.GetHost("Lobby") + "/?channel=Default#/Detail/" + appid;
    ...
    var module = {
        ...
        * @param {String} summary 分享标题 “【Edbox】邀请通知”
        ...
        */
        SharePersonalApp: function (appid, receiveid, summary, iconalt, shareicon, sharetitle, sharecontent, sharetbtntxt, shareurl, success, error) {
            ...
            var arg = '["' + Edbox.AccountId + '", "' + receiveid + '"]';
            ...
            Edbox.Request.PostWithHeader(Edbox.GetHost("IMMsg"), subUrl, json, null, success, error, "https");
        },
        ...
        GetIMFriendList: function (offset, limit, success, error) {
            ...
            var host = Edbox.Protocol.toLowerCase() === 'https' ? Edbox.GetHost("IM_HTTPS") : Edbox.GetHost("IM");
            Edbox.Request.Get(host, subUrl, null, success, error);
        }
    };
