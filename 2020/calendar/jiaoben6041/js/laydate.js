      ...
      for (var n = 0; n < 7; n++) {
        if (k == 0 && n < date1) {
          if (currDate < 7 && preMonthLength - date1 + n + 1 == currDate) {
            if (n == 6) {
              ul2.append(
                '<li class="tabel-li preDays active weekColor">' +
                  (preMonthLength - date1 + n + 1) +
                  "</li>"
              );
            } else {
              ul2.append(
                '<li class="tabel-li preDays active">' +
                  (preMonthLength - date1 + n + 1) +
                  "</li>"
              );
            }
            ...
            if (n == 6) {
              ul2.append(
                '<li class="tabel-li preDays weekColor">' +
                  (preMonthLength - date1 + n + 1) +
                  "</li>"
              );
            } else {
              ul2.append(
                '<li class="tabel-li preDays">' +
                  (preMonthLength - date1 + n + 1) +
                  "</li>"
              );
            }
          ...
          if (k == 0) {
            if (currDate < 7 && dayArr[n - date1] == currDate) {
              if (n == 6) {
                ul2.append(
                  '<li class="tabel-li active weekColor">' +
                    dayArr[n - date1] +
                    "</li>"
                );
              } else {
                ul2.append(
                  '<li class="tabel-li active">' + dayArr[n - date1] + "</li>"
                );
              }
            } else {
              if (n == 6) {
                ul2.append(
                  '<li class="tabel-li weekColor">' +
                    dayArr[n - date1] +
                    "</li>"
                );
              } else {
                ul2.append(
                  '<li class="tabel-li">' + dayArr[n - date1] + "</li>"
                );
              }
            }
          } else {
            if (k * 7 - date1 + n + 1 > dayArr.length) {
              ...
              if (currDate >= 2 && k * 7 - date1 + n + 1 == currDate) {
                ...
                if (n == 0 || n == 6) {
                  ...
                  ul2.append(
                    '<li class="tabel-li">' + (k * 7 - date1 + n + 1) + "</li>"
                  );
                }
              }
              if (k * 7 - date1 + n + 1 == dayArr.length) {
      ...
      if (flag == true) {
        for (var q = 0; q < 6 - currN; q++) {
          $(".tabel-line")
            .eq(currK)
            .children()
            .append('<li class="tabel-li nextDay">' + (q + 1) + "</li>");
        }
        break;
      }
    }
