    ...
    var module = {
        ...
        */
        ...
        ReleaseConfig: function (GameId, success, error) {
            api.ReleaseConfig(GameId, UtilBarn.Version, success, error);
        },
        /**
         * 获取排行榜配置信息列表（编辑库）
         * @param {Function} success 成功回调
        ...
        GetEditConfigList: function (success, error) {
            api.GetConfigList(UtilBarn.GameId, 1, success, error);
        },
        /**
         * 获取排行榜配置信息列表（发布库）
         * @param {Function} success 成功回调
        ...
        GetReleaseConfigList: function (success, error) {
            api.GetConfigList(UtilBarn.GameId, 2, success, error);
        },
        /**
        * 删除排行榜配置
