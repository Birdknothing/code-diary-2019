    ...
    var module = {
        ...
        UploadUserAvatar: function (blob, success, error) {
            ...
            function uploadToCS(avatarPath, sessionId, successCb) {
                ...
                var curl = UtilBarn.Protocol + "://" + UtilBarn.GetHost("CS") + url;
            ...
            // UtilBarn.Request.PostWithHeader(UtilBarn.GetHost("UCUserInfo"), subUrl, userArray, null, success, error, UtilBarn.Protocol);
            UtilBarn.Request.GetWithProtocol(UtilBarn.GetHost("CommonCS"), url, "", function (sessionData) {
                var avatarPath = sessionData.path + "/" + UtilBarn.AccountId + ".jpg";
                uploadToCS(avatarPath, sessionData.session, function () {
                    if (success) success(avatarPath);
                });
            }, error, UtilBarn.Protocol);
        }
    };
