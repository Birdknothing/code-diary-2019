...
(function (namespace, className) {
    /**
     * UtilBarnWebSocket组件
     * 用于UtilBarn平台的WebSocket组件,用于实现WebSocket消息的传递与管理
     * @author 余晓(871129)
    ...
    var module = {
         ...
         */
        Connect : function () {
            if(UtilBarn.Platform.IsIPhone || UtilBarn.Platform.IsAndroid || UtilBarn.Platform.IsIpad || UtilBarn.Platform.IsIOS || UtilBarn.Platform.IsMac){
                return;
            }
            // 监听连接
