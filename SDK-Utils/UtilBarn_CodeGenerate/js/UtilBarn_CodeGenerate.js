    ...
    GenerateJS: function (file, success, error) {
        ...
        function addDatas(datas, isStatic, classname) {
            ...
            for (var i = 0; i < datas.length; i++) {
                ...
                if (!isStatic) {
                    ...
                    addline("UtilBarn." + classname + "." + data.Name + " = " + value + ";", 0);
                }
            }
        }
        ...
        function addFunctions(datas, isStatic, classname) {
            ...
            for (var i = 0; i < datas.length; i++) {
                ...
                if (isStatic) {
                    add("UtilBarn." + classname + "." + data.Name + " = function(");
                } else {
                    add("UtilBarn." + classname + ".prototype." + data.Name + " = function(");
                }
                if (data.Keys && data.Keys.length > 0) {
        ...
        function generate(json) {
            ...
            for (var i = 0; i < keys.length; i++) {
                ...
                addline("UtilBarn." + key + " = function (obj) {");
            ...
            if (success) {
                success(text, "UtilBarn_" + keys[0] + ".js");
            }
        }
    ...
    GenerateDts: function (file, success, error) {
        ...
        function generate(json) {
            ...
            for (var i = 0; i < keys.length; i++) {
                ...
                addline("declare module UtilBarn" + nb + " {");
            ...
            if (success) {
                success(text, "UtilBarn_" + keys[0] + ".d.ts");
            }
        }
    ...
    GenerateCSharp: function (file, success, error) {
        ...
        function generate(json) {
            ...
            function addDepend(json) {
                ...
                //    if (depend[i].Name === "UtilBarn") continue;
                //    if (depend[i].Name.indexOf("UtilBarn.") > 0) continue;
            ...
            if (success) {
                success(text, "UtilBarn_" + keys[0] + ".cs");
            }
        }
    ...
    GenerateWiki: function (file, success, error) {
        ...
        function addFunctions(datas, isStatic, classname) {
            ...
            for (var i = 0; i < datas.length; i++) {
                ...
                if (isStatic) {
                    add("UtilBarn." + classname + "." + data.Name + "(");
                }
                else {
                    add("com." + data.Name + "(");
                }
        ...
        function generate(json) {
            ...
            function addHeader(data, tabcount) {
                ...
                addline("<script src=\"/libs/UtilBarn_" + data.Name + "/js/UtilBarn_" + data.Name + ".js\" type=\"text/javascript\"></script>", tabcount);
                addline("使用CDN库引用的前往：[http://ndsdn.nd.com.cn/index.php?title=UtilBarn_JS_SDK_CDN库 UtilBarn JS SDK CDN库]", tabcount);
                emptyline();
            }
            ...
            function addFooter(data, tabcount) {
                ...
                addline("[https://svn.nd.com.cn/svn/UtilBarn_Gobang/Tool/UtilBarn_JSLibs/UtilBarn_" + data.Name + " https://svn.nd.com.cn/svn/UtilBarn_Gobang/Tool/UtilBarn_JSLibs/UtilBarn_" + data.Name + "]", tabcount);
                emptyline();
                addline("= 测试案例 =", tabcount);
                addline("http://component.UtilBarn-qa.101.com/libs/UtilBarn_" + data.Name + "/", tabcount);
                emptyline();
                emptyline();
                addline("[[Category:UtilBarn组件文档]]", tabcount);
            }
            ...
            function addOtherClass(data) {
                ...
                var hash = com.substring(index + 1);
                addline("= " + hash + " =");
                addline("类型名: UtilBarn." + data.Name);
            }
            ...
            if (success) {
                success(text, "UtilBarn_" + keys[0] + ".txt");
            }
        }
