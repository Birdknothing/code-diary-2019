...
new slideDiv({ mountDiv: document.getElementsByClassName('proviewbox')[0], divName: 'term1' + index, divs: divConfig[parseInt(index)], width: '100%', height: '1016px', slideWidth: '1060px', slideHeight: '812px' });
