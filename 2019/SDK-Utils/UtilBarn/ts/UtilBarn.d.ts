 ...
 * */
declare class UtilBarn {
    /**
     * UtilBarn平台用户id，用于获取平台角色信息
     */
    ...
    /**
     * 账号登陆渠道, "Default"(默认),"UtilBarn","Edmodo","99U","101PPT","101Lms","Frt","Wjt","Hwt","QQ","Weixin","Weibo","Facebook","Google","Twitter","Guest"
     */
    ...
    /**
     * 渠道, "Default"(默认), "UtilBarn", "UtilBarn_cn", "MingXingAPP", "HaoWenTi", "Conquer"
     */
...
declare module UtilBarn {
    ...
    class Platform {
        ...
        public static IsUtilBarn: boolean; // UtilBarn内嵌浏览器
