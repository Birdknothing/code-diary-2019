...
class TagsLobby extends Component {
    ...
    render() {
        ...
        const title = <span>{formatMessage({id:'show_all'})} <Icon type="close"  onClick={()=>this.hide()} style={{'fontSize': '14px','position':'absolute','right':'20px','top':'12px','color':'#999','cursor':'pointer'}} /></span>
        return (
