...
export default {
    ...
    reducers:{
        ...
        setLogin(state,{payload:{isLogin}}){
    ...
    effects: {
        ...
        *shareApp({ payload:{ appId, receiver, appName, iconUrl, access, get_type, version, appDesc }, callback},{ call }){
          const data = yield call(lobbyService.shareApp,{ appId, receiver, appName, iconUrl, access, get_type, version, appDesc })
          if(callback){
              callback(data)
          }
        },
