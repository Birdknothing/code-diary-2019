...
import { controlUrl, ServerKey } from '@/utils/common';
...
class PictureDrawer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      inframeOnLoad: false,
    ...
    return (
      <div style={{height: '100%'}}>
        ...
        <Drawer
          ...
          getContainer={()=>this.props.lobby.el}
          maskClosable={false}
          mask={false}
          zIndex={11}
        >
          <div className={styles.items} style={{ height: '100%' }}>
