...
class GameEdit extends Component {
  ...
  render() {
    ...
    const { currentData = {}, isLogin, controls, pageArr } = edit;
    const { width } = iframeStyle;
    const { PageType = 'Default', Datas= [], IsLevelEdit, Class, Name, Property = {}  } = currentData;
          ...
          <Layout>
            ...
            >
              ...
              >
                ...
                {(pageArr.indexOf(Class) > -1 && pageArr.indexOf(Name) > -1) ? <IframePage iframeHeight = {showLevelNav ? true : false} /> : null}
