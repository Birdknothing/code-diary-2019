...
const localeInfo = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('e:/git-pro/Edbox_H5/Edbox_Editor/Framework/web/src/locales/en-US.js')),
    },
    locale: 'en-US',
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('e:/git-pro/Edbox_H5/Edbox_Editor/Framework/web/src/locales/zh-CN.js')),
    },
    locale: 'zh-CN',
  ...
  'zh-HK': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('e:/git-pro/Edbox_H5/Edbox_Editor/Framework/web/src/locales/zh-HK.js')),
    },
    locale: 'zh-HK',
    antd: require('antd/lib/locale-provider/zh_HK'),
    data: require('react-intl/locale-data/zh'),
    momentLocale: 'zh-hk',
  },
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('e:/git-pro/Edbox_H5/Edbox_Editor/Framework/web/src/locales/zh-TW.js')),
    },
    locale: 'zh-TW',
