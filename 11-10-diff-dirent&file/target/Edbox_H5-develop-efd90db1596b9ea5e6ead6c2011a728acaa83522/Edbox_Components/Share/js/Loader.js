...
var Loader = {
    ...
    InitComponentRootPath: function () {
        ...
        Loader.ComponentRootPath = Loader.Protocol + "://" + window.location.host + "/libs/";
    }
};
...
// <!-- Edbox组件引用 -->
Loader.Load(Loader.ComponentRootPath + "Edbox/js/Edbox.js?v=" + new Date().getTime());
Loader.Load(Loader.ComponentRootPath + "ThirdParty/jquery/jquery-3.3.1.min.js?v=" + new Date().getTime());
Loader.Load(Loader.ComponentRootPath + "ThirdParty/utf/utf.js?v=" + new Date().getTime());
Loader.Load(Loader.ComponentRootPath + "ThirdParty/iconqr/qrcode.js?v=" + new Date().getTime());
