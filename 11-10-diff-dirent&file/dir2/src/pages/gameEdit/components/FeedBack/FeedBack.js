...
class FeedBack extends Component {
    ...
    updateUnReplay = () =>{
        const { dispatch } = this.props
        dispatch({
            type:'FeedBack/getUnReplyFeedBacks',
            payload:{},
            callback:(data)=>{
                // console.log(data)
                if(data){
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                title={formatMessage({id:'feedback_close'})}
                onOk={this.realClose}
                    ...
                    { DetailFeedBacks.map((item,i)=>(
                        ...
                        key={item.id}>
                            <div className={feed['me']}>
                                {
                                    item.type === 0 ?
                                    <Avatar src={Edbox.Avatar} />
                                    :
                                    <Avatar src={kefu} />
                                }
                                {
                                    item.type === 0 ?
                                    <span className={feed['name']}>{Edbox.UserName}</span>
                                    :
