import * as FeedBackService from '../pages/gameEdit/components/FeedBack/services/FeedBack';
...
export default {
    ...
    effects: {
        ...
        *getFeedBacks({ payload: { page },callback }, { call, put }) {
            const data = yield call(FeedBackService.getFeedBacks, { page });
            if(callback){
                callback(data)
            }
        },
        ...
        *getUnReplyFeedBacks({ payload, callback},{ call }){
          const data = yield call(FeedBackService.getUnReplyFeedBacks)
          if(callback){
              callback(data)
          }
        },
